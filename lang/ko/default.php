...
return [
    ...
    'errors' => [
        'cannot_leave_account' => '생성한 회사를 떠날 수 없습니다.',
        ...
        'user_belongs_to_account' => '이 사용자는 이미 회사에 속해 있습니다.',
    ...
    'banner' => [
        'account_invitation_accepted' => '**:account** 에 대한 초대를 수락했습니다.',
    ],
    ...
    'navigation' => [
        'headers' => [
            'manage_account' => '회사 관리',
            'switch_accounts' => '회사 전환',
        ],

        'links' => [
            'tokens' => '개인 액세스 토큰',
            'account_settings' => '회사 설정',
            'create_account' => '회사 생성',
        ],
    ],
    ...
    'grid_section_descriptions' => [
        ...
        'create_account' => '다른 사용자와 프로젝트를 협업하기 위해 새로운 회사를 생성합니다.',
