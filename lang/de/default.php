...
return [
    ...
    'errors' => [
        'cannot_leave_account' => 'Sie können eine Firma, die Sie erstellt haben, nicht verlassen.',
        ...
        'user_belongs_to_account' => 'Dieser Benutzer gehört bereits zur Firma.',
    ...
    'banner' => [
        'account_invitation_accepted' => 'Super! Sie haben die Einladung angenommen, **:account** beizutreten.',
    ],
    ...
    'navigation' => [
        'headers' => [
            'manage_account' => 'Firma verwalten',
            'switch_accounts' => 'Firmen wechseln',
        ],

        'links' => [
            'tokens' => 'Persönliche Zugangstokens',
            'account_settings' => 'Firmeneinstellungen',
            'create_account' => 'Firma erstellen',
        ],
    ],
    ...
    'grid_section_descriptions' => [
        ...
        'create_account' => 'Erstellen Sie eine neue Firma, um mit anderen an Projekten zusammenzuarbeiten.',
