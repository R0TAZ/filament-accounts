...
return [
    ...
    'errors' => [
        'cannot_leave_account' => 'あなた自身が登録した会社からの退社はできません。',
        ...
        'user_belongs_to_account' => 'ご指定のユーザーはすでに社員として登録されています。',
    ...
    'banner' => [
        'account_invitation_accepted' => 'おめでとうございます！ **:account**の招待を受理しました！',
    ],
    ...
    'navigation' => [
        'headers' => [
            'manage_account' => '会社設定',
            'switch_accounts' => '会社を切り替える',
        ],

        'links' => [
            'tokens' => 'APIトークン一覧',
            'account_settings' => '会社設定',
            'create_account' => '新規会社登録',
        ],
    ],
    ...
    'grid_section_descriptions' => [
        ...
        'create_account' => '新規会社を登録し、共同でプロジェクトを進めるために社員を招待します。',
