...
return [
    ...
    'labels' => [
        ...
        'account_owner' => 'Bedrijf eigenaar',
        'connected' => 'Verbonden',
    ...
    'errors' => [
        'cannot_leave_account' => 'Je kan het bedrijf niet verlaten, welke jij hebt aangemaakt.',
        ...
        'user_belongs_to_account' => 'Deze gebruiker behoort al tot het bedrijf.',
    ...
    'banner' => [
        'account_invitation_accepted' => 'Top! Je bent uitgenodigd om je aan te sluiten bij **:account**.',
    ],
    ...
    'navigation' => [
        'headers' => [
            'manage_account' => 'Beheer bedrijf',
            'switch_accounts' => 'Wissel van bedrijf',
        ],

        'links' => [
            'tokens' => 'Persoonlijke Toegangstokens',
            'account_settings' => 'Bedrijfsinstellingen',
            'create_account' => 'Bedrijf aanmaken',
        ],
    ],
    ...
    'grid_section_descriptions' => [
        ...
        'create_account' => 'Creëer een nieuw bedrijf om met anderen aan projecten samen te werken.',
