...
return [
    ...
    'labels' => [
        'account_name' => 'اسم الشركة',
        'account_owner' => 'مالك الشركة',
    ...
    'errors' => [
        'account_deletion' => 'لا يمكنك حذف شركتك الشخصية.',
        ...
        'user_belongs_to_account' => 'هذا المستخدم ينتمي بالفعل إلى الشركة.',
        'party_already_invited' => 'تم دعوة هذا الموظف بالفعل إلى الشركة.',
        'party_already_belongs_to_account' => 'ينتمي هذا الموظف بالفعل إلى الشركة.',
        'cannot_leave_account' => 'لا يمكنك مغادرة الشركة التي أنشأتها.',
    ...
    'banner' => [
        'account_invitation_accepted' => 'عظيم! لقد قبلت الدعوة للانضمام إلى :account',
    ...
    'navigation' => [
        'headers' => [
            'manage_account' => 'إدارة الشركة',
            'switch_accounts' => 'تغيير الشركات',
        ],

        'links' => [
            'account_settings' => 'إعدادات الشركة',
            'new_account' => 'شركة جديدة',
            'tokens' => 'رموز API',
        ],
    ],
    ...
    'grid_section_titles' => [
        ...
        'account_name' => 'اسم الشركة',
        'create_account' => 'إنشاء شركة جديدة',
        'add_account_party' => 'إضافة موظف للشركة',
    ...
    'grid_section_descriptions' => [
        ...
        'account_name' => 'اسم الشركة ومعلومات المالك.',
        'create_account' => 'إنشاء شركة جديدة للتعاون مع الآخرين في المشاريع.',
        'add_account_party' => 'إضافة موظف جديد إلى شركتك للسماح لهم بالتعاون معك.',
        'set_password' => 'تأكد من استخدام حسابك لكلمة مرور عشوائية وطويلة للبقاء آمنًا.',
    ],
    'action_section_titles' => [
        'pending_account_invitations' => 'دعوات الشركة المعلقة',
        'account_party' => 'موظفي الشركة',
        'delete_account' => 'حذف الشركة',
        'connected_accounts' => 'الحسابات المتصلة',
    ],
    'action_section_descriptions' => [
        'pending_account_invitations' => 'تمت دعوة هؤلاء الأشخاص لشركتك وتم إرسال رسالة دعوة لهم. يمكنهم الانضمام للشركة عن طريق قبول دعوة البريد الإلكتروني.',
        'account_party' => 'جميع الأشخاص الذين يعملون في هذه الشركة.',
        'delete_account' => 'حذف هذه الشركة بشكل دائم.',
    ...
    'modal_titles' => [
        ...
        'leave_account' => 'مغادرة الشركة',
        'remove_account_party' => 'إزالة موظف الشركة',
    ...
    'modal_descriptions' => [
        ...
        'leave_account' => 'هل أنت متأكد أنك تريد مغادرة هذه الشركة؟',
        'remove_account_party' => 'هل أنت متأكد أنك تريد إزالة هذا الشخص من الشركة؟',
        ...
        'delete_account' => 'هل أنت متأكد أنك تريد حذف هذه الشركة؟ بمجرد حذف الشركة ، سيتم حذف جميع الموارد والبيانات الخاصة بها بشكل دائم.',
    ...
    'subheadings' => [
        ...
        'accounts' => [
            'account_party_manager' => 'يرجى تقديم عنوان البريد الإلكتروني للشخص الذي ترغب في إضافته إلى هذه الشركة.',
            'delete_account' => 'بمجرد حذف الشركة، سيتم حذف جميع الموارد والبيانات الخاصة بها بشكل دائم. قبل حذف هذه الشركة، يرجى تنزيل أي بيانات أو معلومات ترغب في الاحتفاظ بها.',
        ],
    ],
];
