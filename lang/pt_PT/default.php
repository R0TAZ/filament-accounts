...
return [
    ...
    'errors' => [
        'cannot_leave_account' => 'Não pode sair de uma empresa que criou.',
        ...
        'user_belongs_to_account' => 'Este utilizador já pertence à empresa.',
    ...
    'banner' => [
        'account_invitation_accepted' => 'Ótimo! Aceitou o convite para juntar-se à **:account**.',
    ],
    ...
    'grid_section_descriptions' => [
        ...
        'create_account' => 'Crie uma nova empresa para colaborar com outras em projetos.',
