...
return [
    ...
    'labels' => [
        ...
        'account_owner' => 'Propietario de la empresa',
    ...
    'navigation' => [
        'headers' => [
            'manage_account' => 'Administrar empresa',
            'switch_accounts' => 'Cambiar de empresa',
        ],

        'links' => [
            'account_settings' => 'Configuración de empresa',
            'new_account' => 'Nueva Conta',
    ...
    'pages' => [
        'titles' => [
            ...
            'account_settings' => 'Configuración de la empresa',
            'tokens' => 'Personal Access Tokens',
            'profile' => 'Perfil',
        ],
    ],
