...
return [
    ...
    'labels' => [
        ...
        'account_email' => 'E-mail společnosti',
        'account_owner' => 'Vlastník společnosti',
    ...
    'errors' => [
        'cannot_leave_account' => 'Nemůžete opustit společnost, kterou jste vytvořili.',
        ...
        'user_belongs_to_account' => 'Tento uživatel již patří do společnosti.',
    ...
    'banner' => [
        'account_invitation_accepted' => 'Skvělé! Přijali jste pozvání k připojení do **:account**.',
    ],
    ...
    'navigation' => [
        'headers' => [
            'manage_account' => 'Správa společnost',
            'switch_accounts' => 'Přepnout společnost',
        ],

        'links' => [
            'tokens' => 'Osobní přístupové tokeny',
            'account_settings' => 'Nastavení společnosti',
            'create_account' => 'Vytvořit společnost',
        ],
    ],
    ...
    'grid_section_descriptions' => [
        ...
        'create_account' => 'Vytvořte novou společnost pro spolupráci s ostatními na projektech.',
