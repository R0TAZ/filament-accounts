...
return [
    ...
    'labels' => [
        ...
        'account_owner' => 'Propriétaire de l\'entreprise',
        'connected' => 'Connecté',
        'created_at' => 'Créé le',
    ...
    'errors' => [
        'cannot_leave_account' => 'Vous ne pouvez pas quitter une entreprise que vous avez créée.',
        ...
        'user_belongs_to_account' => 'Cet utilisateur appartient déjà à l\'entreprise.',
    ...
    'banner' => [
        'account_invitation_accepted' => 'Super ! Vous avez accepté l\'invitation à rejoindre **:account**.',
    ],
    ...
    'navigation' => [
        'headers' => [
            'manage_account' => 'Gérer l\'entreprise',
            'switch_accounts' => 'Changer d\'entreprise',
        ],

        'links' => [
            'tokens' => 'Jeton d\'accès personnel',
            'account_settings' => 'Paramètres de l\'entreprise',
            'create_account' => 'Créer une entreprise',
        ],
    ],
    ...
    'grid_section_descriptions' => [
        ...
        'create_account' => 'Créez une nouvelle entreprise pour collaborer avec d\'autres sur des projets.',
