...
return [
    ...
    'labels' => [
        ...
        'account_owner' => 'Pemilik Perusahaan',
    ...
    'errors' => [
        'cannot_leave_account' => 'Anda tidak dapat meninggalkan perusahaan yang Anda buat.',
        ...
        'user_belongs_to_account' => 'Pengguna ini sudah termasuk dalam perusahaan.',
    ...
    'banner' => [
        'account_invitation_accepted' => 'Bagus! Anda telah menerima undangan untuk bergabung dengan **:account**.',
    ],
    'notifications' => [
        'token_created' => [
    ...
    'navigation' => [
        'headers' => [
            'manage_account' => 'Kelola Perusahaan',
            'switch_accounts' => 'Ganti Perusahaan',
        ],

        'links' => [
            'tokens' => 'Token Akses Pribadi',
            'account_settings' => 'Pengaturan Perusahaan',
            'create_account' => 'Buat Perusahaan',
        ],
    ],
    ...
    'grid_section_descriptions' => [
        ...
        'create_account' => 'Buat perusahaan baru untuk berkolaborasi dengan orang lain dalam proyek.',
