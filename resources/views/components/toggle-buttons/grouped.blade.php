@php
    ...
    $statePath = $getStatePath();
        $iconImages = [
        'personal' => asset('images/icons/icone-personal.png'),
        'business' => asset('images/icons/icone-organization.png'),
    ];
@endphp
    ...
    >
        @foreach ($getOptions() as $value => $label)
            ...
            >
                ...
                >
                    <img
                        src="{{ $iconImages[$value] ?? asset('images/default-icon.png') }}"
                        alt="{{ $label }}"
                        width="150"
                        height="150"
                        class="mb-2"
