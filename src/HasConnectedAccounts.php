...
trait HasConnectedAccounts
{
    ...
    public function currentConnectedAccount(): BelongsTo
    {
        ...
        return $this->belongsTo(FilamentAccounts::connectedAccountModel(), 'current_connected_account_id');
    }
    ...
    {
        return $this->hasMany(FilamentAccounts::connectedAccountModel(), 'user_id', $this->getAuthIdentifierName());
    }
}