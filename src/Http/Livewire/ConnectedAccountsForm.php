...
class ConnectedAccountsForm extends Component
{
    ...
    {
        return FilamentAccounts::enabledProviders();
    }
    ...
    {
        return view('filament-accounts::profile.connected-accounts-form');
    }
    ...
    {
        Notification::make()
            ->title(__('filament-accounts::default.notifications.connected_account_removed.title'))
            ->success()
            ->body(__('filament-accounts::default.notifications.connected_account_removed.body'))
            ->send();
    }
}
