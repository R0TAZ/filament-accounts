...
class UpdateProfileInformationForm extends Component
{
    ...
    {
        Notification::make()
            ->title(__('filament-accounts::default.notifications.profile_information_updated.title'))
            ->success()
            ->body(__('filament-accounts::default.notifications.profile_information_updated.body'))
            ->send();
    }
    ...
    public function sendEmailVerification(): void
    {
        ...
        Notification::make()
            ->title(__('filament-accounts::default.notifications.verification_link_sent.title'))
            ->success()
            ->body(__('filament-accounts::default.notifications.verification_link_sent.body'))
            ->send();
    }
    ...
    {
        return view('filament-accounts::profile.update-profile-information-form');
    }
}
